    ...
    <section className="about">
        ...
        <div className="right-content">
          <div className="description">
            ...
            >
              ...
              world, At BritIndia, we're not just tech fans. We're like dream
            ...
            >
              ...
              playground of BritIndia! Pull up a virtual chair and get ready
      ...
      <div className="why">
        <div className="content">
          <div className="one">Why BritIndia?</div>
          <div className="two">
        ...
        <p className="description">
          You might be wondering, "Why choose BritIndia?" Well, aside from our
        ...
        <div className="left-div">
          <div className="left-card">
            ...
            <div className="card-div">
              ...
              <p>
                Now, you might be wondering, "What exactly does BritIndia do?"
                ...
                leap, BritIndia is your ultimate partner in digital success.
              </p>
            </div>
          </div>
        ...
        <div className="right-div">
          <div className="right-card">
            ...
            <div className="card-div">
              ...
              <p>
                When you work with BritIndia, you're not just another
        ...
        <div className="flex-div">
          <div className="description-div">
            <p className="desc-one">
              So, why choose BritIndia? Because in a world filled with
            ...
            <div className="desc-two">
              <p className="line-one">
                ...
                <br />
                madness and join us in the twisted realm of BritIndia.
                <br />
